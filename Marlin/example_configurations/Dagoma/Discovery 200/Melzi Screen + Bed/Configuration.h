 ...
 *    17 : 100k thermistor - Alternative ATC Semitec 104GT-2 (4.7k pullup) DAGOMA - MKS_Base - version (measured/tested/approved)
 *    18 : 100k thermistor - Alternative ATC Semitec 204GT-2 (4.7k pullup) DAGOMA - MKS_Base_DKU001327 - version (measured/tested/approved)
...
#if ENABLED(TEMP_SENSOR_BED)
# define Z_MAX_POS (205 - 20) // Adjusted for bed
#else
