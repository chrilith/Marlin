...
#endif
#if ANY_THERMISTOR_IS(16) // DAGOMA alternative ATC Semitec 104GT-2
  #include "thermistortable_16.h"
#endif
#if ANY_THERMISTOR_IS(17) // DAGOMA alternative ATC Semitec 104GT-2 - MKS_Base
  #include "thermistortable_17.h"
#endif
#if ANY_THERMISTOR_IS(18) // DAGOMA alternative ATC Semitec 104GT-2 - MKS_Base_DKU001327
